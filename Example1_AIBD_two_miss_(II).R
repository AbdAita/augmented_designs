...
augmented_AIBD<-augmented_AIBD[-c(28),]#The check treatment G35 has been missed in the first block#
augmented_AIBD<-augmented_AIBD[-c(93),]#The check treatment G35 has been missed in the third block#
...
TMC.II.ARIBD(obs, block, treatment,type,y,1,3,3,3)
